...
namespace Player
{
    public class Moving_PC_V1 : IMoving
    {
        ...
        private Vector2 directCollision;
        ...
        private void Update()
        {
            ...
            {
                this.transform.Translate(direction * 3f * Time.deltaTime);
            }
        }
        ...
        private void OnCollisionEnter2D(Collision2D collision)
        {
            if (collision.gameObject.CompareTag("Map")) {
                ...
                directCollision = pos- (Vector2)transform.position;
                if (directCollision.x * direction.x >= 0 && directCollision.y * direction.y >= 0) {
