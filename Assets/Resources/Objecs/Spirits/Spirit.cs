...
public class Spirit : MonoBehaviour
{
    ...
    virtual public Transform PointSpiritInPlayer { get => pointSpiritInPlayer; set => pointSpiritInPlayer = value; }
    virtual public float WaitingShootTime { get => waitingShootTime; }

    virtual public void config(Player.Player player, Transform pointSpiritInPlayer)
    {
        this.player = player;
   ...
   virtual  public void shoot(Player.IShoot shooting, Vector2 mousePostion)
    {
    ...
    virtual public void switchRoom(Vector2 pos) {
        setHiddenTrail(true);
        State = INDLE_WAITING;
        isSwitchRoom = true;
